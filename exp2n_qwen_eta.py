# Эксперимент 2n: η из УДИВЛЕНИЯ ОСНОВНОЙ СЕТИ (энтропия Qwen) вместо mask_secret.
...
def main():
    ...
    torch.save(model.state_dict(), "exp2n_qwen_eta.pt")
    print("Сохранено: exp2n_qwen_eta.pt", flush=True)
