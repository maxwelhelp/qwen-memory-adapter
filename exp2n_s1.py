# Эксперимент 2n-s1: проверка воспроизводимости — тот же exp2n, сплит rng=1 (энтропия Qwen) вместо mask_secret.
...
def main():
    ...
    torch.save(model.state_dict(), "exp2n_s1.pt")
    print("Сохранено: exp2n_s1.pt", flush=True)
