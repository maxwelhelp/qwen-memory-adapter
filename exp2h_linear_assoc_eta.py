# Эксперимент 2h: ЛИНЕЙНЫЕ АССОЦИАТИВНЫЕ СЛОТЫ + delta-rule запись + η-гейт + проекции.
...
def main():
    ...
    torch.save(model.state_dict(), "exp2h_linear_assoc_eta.pt")
    print("Сохранено: exp2h_linear_assoc_eta.pt", flush=True)
