# Эксперимент 2n-FULL: полный масштаб (N_TRAIN=320, EPOCHS=40) схемы exp2n
# (η из энтропии Qwen, без учителя). Одна переменная vs exp2n: масштаб.
# Ожидание: межсессионный ≥ 40/40.
...
def main():
    ...
    torch.save(model.state_dict(), "exp2n_full.pt")
    print("Сохранено: exp2n_full.pt", flush=True)
